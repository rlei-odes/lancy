            ...
            <div className="max-w-2xl rounded-xl border border-border bg-card shadow-sm p-4 flex flex-col gap-3">
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div ref={fileComboRef} className="relative flex-1 min-w-0 max-w-xs">
                        <div className={cn(
                            "flex items-center gap-1 border rounded-md bg-muted/40 px-2 py-1.5",
                    ...
                    return (
                        <div key={i} className="flex items-center gap-2">
                            <select
                                ...
                                className="text-xs bg-muted/40 border border-border rounded-md px-2 py-1.5 outline-none flex-1"
                            >
